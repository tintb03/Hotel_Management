    ...
    <form action="{{ route('admin.hotel.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="hoteler_id" name="hoteler_id" required>
                <option value="">Select Hoteler</option>
                @foreach ($hotelers as $hoteler)
                    <option value="{{ $hoteler->id }}">{{ $hoteler->name_hoteler }}</option>
                @endforeach
            </select>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="detailed_address" name="detailed_address" required>
        </div>
        <div class="form-group">
            <label for="Number_of_rooms">Number of Rooms:</label>
            <input type="number" class="form-control" id="Number_of_rooms" name="Number_of_rooms" required>
        </div>
        <div class="form-group">
